...
const SITE_DOMAIN =
  process.env.NEXT_PUBLIC_SITE_URL || "https://admin.korsimnaturals.com";
    ...
    <div className="min-h-screen bg-[#f8f9fa] font-sans">
      <main className="container mx-auto px-3 sm:px-4 lg:px-8 py-5 md:py-8 max-w-7xl">
        ...
        <div className="mb-6">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-zinc-500 hover:text-red-600 transition-all font-bold text-[11px] md:text-[13px]"
          >
                ...
                <div>
                  <p className="text-zinc-900 font-bold uppercase text-sm tracking-tight mb-1">
                    ...
                    <span className="text-red-600">
                      {article.author?.name || "Robin"}
                    </span>
                  </p>
                  <span className="text-zinc-400 text-[10px] font-black uppercase tracking-widest block opacity-70">
                    DNV Editorial Staff
                  </span>
                </div>
